  ...
  <body>
    <main>
        ...
        <div class="info-produto">
            <?php
              echo '
              <h1>' . $resultado['nome_produto'] . '</h1>
              <p>' . $resultado['descricao_produto'] . '</p>
              <p><b>Peso: </b>' . $resultado['peso_produto'] . 'g</p>
              <p><b>Categoria: </b>' . $resultado['nome_categoria'] . '</p>
              <b>Classificação</b>
              ...
              <div class="dinheiro">
                  <span>R$ ' . $resultado['preco_produto'] . '</span>
            ...
            ?>
            <a href="observacao.html"><u>Adicionar uma observação</u></a>
        </div>
        <div id="quantidade">
        ...
        <a href="avaliar.html" class="avaliar">Avaliar este produto</a>
    </main>
