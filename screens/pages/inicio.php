...
<body>
  <main>
    ...
    <a href="destaques.html" id="ver-destaques">
        ...
        <a href="user.html">
          <div>
            <svg width="27" height="28" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M13.5 2.33334C7.28663 2.33334 2.25 7.55651 2.25 14C2.25 20.4435 7.28663 25.6667 13.5 25.6667C19.7134 25.6667 24.75 20.4435 24.75 14C24.75 7.55651 19.7134 2.33334 13.5 2.33334Z"
                stroke="#494949" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path
                d="M4.80493 21.4037C4.80493 21.4037 7.31256 18.0833 13.5001 18.0833C19.6876 18.0833 22.1963 21.4037 22.1963 21.4037"
                stroke="#494949" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path
                d="M13.5 14C14.3951 14 15.2536 13.6313 15.8865 12.9749C16.5194 12.3185 16.875 11.4283 16.875 10.5C16.875 9.57174 16.5194 8.6815 15.8865 8.02513C15.2536 7.36875 14.3951 7 13.5 7C12.6049 7 11.7464 7.36875 11.1135 8.02513C10.4806 8.6815 10.125 9.57174 10.125 10.5C10.125 11.4283 10.4806 12.3185 11.1135 12.9749C11.7464 13.6313 12.6049 14 13.5 14V14Z"
                stroke="#494949" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </div>
          Perfil
